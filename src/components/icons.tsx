// Small inline icon set — stroke style matches the brand mark (rounded caps).
type IconProps = { className?: string }

export function BookIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="M5 4.5A1.5 1.5 0 0 1 6.5 3H18a1 1 0 0 1 1 1v13H6.5A1.5 1.5 0 0 0 5 18.5v-14Z" />
...
export function HeartIcon({ className, filled }: IconProps & { filled?: boolean }) {
  return (
    <svg viewBox="0 0 24 24" fill={filled ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="M12 20.3 4.7 13a4.4 4.4 0 0 1 6.2-6.2l1.1 1.1 1.1-1.1a4.4 4.4 0 0 1 6.2 6.2Z" />
    </svg>
  )
}
...
export function CartIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.8} strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true">
      <path d="M3 4h2l2.4 11.2a1.5 1.5 0 0 0 1.5 1.2h7.7a1.5 1.5 0 0 0 1.5-1.2L21 8H6" />
...
export function FlameIcon({ className }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className={className} aria-hidden="true">
      <path d="M12 2.3c.4 3-1.5 4.6-2.9 5.9C7.4 9.7 6 11.2 6 13.8a6 6 0 0 0 12 0c0-2.3-1.1-4-2.3-5.4-.5.6-1 .9-1.7 1 .8-2.3-.2-4.9-2-7.1zM12 19.5a2.7 2.7 0 0 1-2.7-2.7c0-1.3.8-2.2 1.5-2.9.3.9.9 1.3 1.7 1.5 1-.2 1.4-.9 1.6-1.6.7.7 1.3 1.6 1.3 2.7a2.7 2.7 0 0 1-2.7 2.7z" />
    </svg>
  )
}
